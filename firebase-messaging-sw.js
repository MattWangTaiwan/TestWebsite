importScripts("/precache-manifest.092c410938fca6ec375b14afda473c8a.js", "https://storage.googleapis.com/workbox-cdn/releases/4.3.1/workbox-sw.js");
...
messaging.onBackgroundMessage((payload) => {
  ...
  this.registration.showNotification(payload.data['gcm.notification.NotifSubject'], {
    body: payload.data['gcm.notification.NotifContent'],
    actions: [
      { action: 'click', title: '前往' },
